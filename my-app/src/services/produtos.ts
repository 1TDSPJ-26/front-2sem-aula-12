import type { DadosProduto, TipoProduto } from "../types/produto";
...
export async function criarProduto(dados: DadosProduto): Promise<TipoProduto> {
...
export async function atualizarProduto(id: string, dados: DadosProduto): Promise<TipoProduto> {
